...
void XHud_gen_Set_ball_y(XHud_gen *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHud_gen_WriteReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_Y_DATA, Data);
}

u32 XHud_gen_Get_ball_y(XHud_gen *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHud_gen_ReadReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_Y_DATA);
    return Data;
}

void XHud_gen_Set_ball_x(XHud_gen *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHud_gen_WriteReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_X_DATA, Data);
}

u32 XHud_gen_Get_ball_x(XHud_gen *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHud_gen_ReadReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_X_DATA);
    return Data;
}

void XHud_gen_Set_ball_size(XHud_gen *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHud_gen_WriteReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_SIZE_DATA, Data);
}

u32 XHud_gen_Get_ball_size(XHud_gen *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHud_gen_ReadReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_SIZE_DATA);
    return Data;
}

void XHud_gen_Set_ball_colour(XHud_gen *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHud_gen_WriteReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_COLOUR_DATA, Data);
}

u32 XHud_gen_Get_ball_colour(XHud_gen *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHud_gen_ReadReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BALL_COLOUR_DATA);
    return Data;
}

void XHud_gen_Set_bar_pos_x(XHud_gen *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHud_gen_WriteReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BAR_POS_X_DATA, Data);
}

u32 XHud_gen_Get_bar_pos_x(XHud_gen *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHud_gen_ReadReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BAR_POS_X_DATA);
    return Data;
}

void XHud_gen_Set_bar_width(XHud_gen *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XHud_gen_WriteReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BAR_WIDTH_DATA, Data);
}

u32 XHud_gen_Get_bar_width(XHud_gen *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XHud_gen_ReadReg(InstancePtr->Axilites_BaseAddress, XHUD_GEN_AXILITES_ADDR_BAR_WIDTH_DATA);
    return Data;
}
