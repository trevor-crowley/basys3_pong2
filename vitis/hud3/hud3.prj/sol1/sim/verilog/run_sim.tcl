...
set ret [catch {eval exec ./cosim.tv.exe /home/trevor/Documents/xilinx/basys3_pong2/vitis/hud3/data/128x128_1.png /home/trevor/Documents/xilinx/basys3_pong2/vitis/hud3/data/128x128_2.png | tee temp0.log >&@ stdout} err]
...
if {[file isfile extractEFrames_accel.autotvin.dat]} {
	file delete -force extractEFrames_accel.autotvin.dat
}

if {[file isfile extractEFrames_accel.autotvout.dat]} {
	file delete -force extractEFrames_accel.autotvout.dat
}
...
set ret [catch {eval exec ./cosim.pc.exe /home/trevor/Documents/xilinx/basys3_pong2/vitis/hud3/data/128x128_1.png /home/trevor/Documents/xilinx/basys3_pong2/vitis/hud3/data/128x128_2.png | tee temp0.log >&@ stdout} err]
