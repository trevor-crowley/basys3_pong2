...
module extractEFrames_accel_Block_entry5_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_block_state1;
wire   [11:0] LEF_Img_rows_fu_26_p1;
wire   [11:0] LEF_Img_cols_fu_38_p1;
wire   [12:0] InImg_rows_fu_30_p3;
wire   [11:0] InImg_cols_fu_42_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_0_preg[12 : 1] <= InImg_rows_fu_30_p3[12 : 1];
        end
    end
end
...
assign InImg_cols_fu_42_p2 = (LEF_Img_cols_fu_38_p1 + 12'd8);

assign InImg_rows_fu_30_p3 = {{LEF_Img_rows_fu_26_p1}, {1'd0}};

assign LEF_Img_cols_fu_38_p1 = width[11:0];

assign LEF_Img_rows_fu_26_p1 = height[11:0];
...
endmodule //extractEFrames_accel_Block_entry5_proc
