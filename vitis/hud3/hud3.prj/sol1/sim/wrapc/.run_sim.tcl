...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe /home/trevor/Documents/xilinx/basys3_pong2/vitis/hud3/data/128x128_1.png /home/trevor/Documents/xilinx/basys3_pong2/vitis/hud3/data/128x128_2.png | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "extractEFrames_accel.autotvin.dat"
	set constFileTvOut       "extractEFrames_accel.autotvout.dat"
	set constFileHdlTvIn     "extractEFrames_accel.autohdltvin.dat"
	set constFileHdlTvOut    "extractEFrames_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
