...
entity hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_start_hunt_fu_179_s_axi_video_TREADY : STD_LOGIC;
    ...
    signal grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_col_zxi2mat_fu_199_s_axi_video_TREADY : STD_LOGIC;
    ...
    signal grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_last_hunt_fu_226_s_axi_video_TREADY : STD_LOGIC;
    ...
    signal regslice_both_s_axi_video_V_data_V_U_apdone_blk : STD_LOGIC;
    signal s_axi_video_TDATA_int_regslice : STD_LOGIC_VECTOR (15 downto 0);
    signal s_axi_video_TVALID_int_regslice : STD_LOGIC;
    signal s_axi_video_TREADY_int_regslice : STD_LOGIC;
    signal regslice_both_s_axi_video_V_data_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axi_video_V_keep_V_U_apdone_blk : STD_LOGIC;
    signal s_axi_video_TKEEP_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    signal regslice_both_s_axi_video_V_keep_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axi_video_V_keep_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axi_video_V_strb_V_U_apdone_blk : STD_LOGIC;
    signal s_axi_video_TSTRB_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    signal regslice_both_s_axi_video_V_strb_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axi_video_V_strb_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axi_video_V_user_V_U_apdone_blk : STD_LOGIC;
    signal s_axi_video_TUSER_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    signal regslice_both_s_axi_video_V_user_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axi_video_V_user_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axi_video_V_last_V_U_apdone_blk : STD_LOGIC;
    signal s_axi_video_TLAST_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    signal regslice_both_s_axi_video_V_last_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axi_video_V_last_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axi_video_V_id_V_U_apdone_blk : STD_LOGIC;
    signal s_axi_video_TID_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    signal regslice_both_s_axi_video_V_id_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axi_video_V_id_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axi_video_V_dest_V_U_apdone_blk : STD_LOGIC;
    signal s_axi_video_TDEST_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    signal regslice_both_s_axi_video_V_dest_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axi_video_V_dest_V_U_ack_in : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_start_hunt IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_col_zxi2mat IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_last_hunt IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_start_hunt_fu_179 : component hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_start_hunt
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_col_zxi2mat_fu_199 : component hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_col_zxi2mat
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_last_hunt_fu_226 : component hud_accel_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_last_hunt
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    regslice_both_s_axi_video_V_data_V_U : component hud_accel_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axi_video_V_keep_V_U : component hud_accel_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axi_video_V_strb_V_U : component hud_accel_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axi_video_V_user_V_U : component hud_accel_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axi_video_V_last_V_U : component hud_accel_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axi_video_V_id_V_U : component hud_accel_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axi_video_V_dest_V_U : component hud_accel_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    s_axi_video_TREADY <= regslice_both_s_axi_video_V_data_V_U_ack_in;

    s_axi_video_TREADY_int_regslice_assign_proc : process(grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_start_hunt_fu_179_s_axi_video_TREADY, grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_col_zxi2mat_fu_199_s_axi_video_TREADY, grp_AXIVideo2BayerMat_0_4320_3848_2_3_Pipeline_loop_last_hunt_fu_226_s_axi_video_TREADY, ap_CS_fsm_state3, ap_CS_fsm_state7, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            ...
            s_axi_video_TREADY_int_regslice <= ap_const_logic_0;
        end if; 
    end process;
