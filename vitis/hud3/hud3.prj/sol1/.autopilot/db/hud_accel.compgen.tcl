...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axi_video_TDATA { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axi_video_TDEST { I 1 vector } s_axi_video_TVALID { I 1 bit } s_axi_video_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_video_lef_TDEST { O 1 vector } m_axis_video_lef_TVALID { O 1 bit } m_axis_video_lef_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_video_sef_TDEST { O 1 vector } m_axis_video_sef_TVALID { O 1 bit } m_axis_video_sef_TREADY { I 1 bit } } \
} "
} else {
