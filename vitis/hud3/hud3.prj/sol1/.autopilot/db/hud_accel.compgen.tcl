...
# FIFO definition: 
set ID 183
set FifoName hud_accel_fifo_w13_d2_S
set InstName InImg_rows_channel_U
...
# FIFO definition: 
set ID 184
set FifoName hud_accel_fifo_w12_d4_S
set InstName LEF_Img_cols_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 4
...
set ID 185
set FifoName hud_accel_fifo_w12_d4_S
set InstName SEF_Img_rows_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 4
...
set ID 186
set FifoName hud_accel_fifo_w12_d4_S
set InstName SEF_Img_cols_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 4
...
# FIFO definition: 
set ID 187
set FifoName hud_accel_fifo_w12_d2_S
set InstName InImg_cols_c15_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
# FIFO definition: 
set ID 188
set FifoName hud_accel_fifo_w12_d3_S
set InstName LEF_Img_rows_c16_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 3
...
# FIFO definition: 
set ID 189
set FifoName hud_accel_fifo_w16_d3_S
set InstName InImg_data_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 3
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 194 \
			corename hud_accel_control_axilite \
			name hud_accel_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler hud_accel_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_ptr_TDATA { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_ptr_TDEST { I 1 vector } in_ptr_TVALID { I 1 bit } in_ptr_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 202 \
    name lef_ptr_V_data_V \
    reset_level 0 \
    sync_rst true \
    corename {lef_ptr} \
    metadata {  } \
    op interface \
    ports { lef_ptr_TDATA { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lef_ptr_V_data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 203 \
    name lef_ptr_V_keep_V \
    reset_level 0 \
    sync_rst true \
    corename {lef_ptr} \
    metadata {  } \
    op interface \
    ports { lef_ptr_TKEEP { O 2 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lef_ptr_V_keep_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 204 \
    name lef_ptr_V_strb_V \
    reset_level 0 \
    sync_rst true \
    corename {lef_ptr} \
    metadata {  } \
    op interface \
    ports { lef_ptr_TSTRB { O 2 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lef_ptr_V_strb_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 205 \
    name lef_ptr_V_user_V \
    reset_level 0 \
    sync_rst true \
    corename {lef_ptr} \
    metadata {  } \
    op interface \
    ports { lef_ptr_TUSER { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lef_ptr_V_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 206 \
    name lef_ptr_V_last_V \
    reset_level 0 \
    sync_rst true \
    corename {lef_ptr} \
    metadata {  } \
    op interface \
    ports { lef_ptr_TLAST { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lef_ptr_V_last_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { lef_ptr_TID { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lef_ptr_V_id_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 208 \
    name lef_ptr_V_dest_V \
    reset_level 0 \
    sync_rst true \
    corename {lef_ptr} \
    metadata {  } \
    op interface \
    ports { lef_ptr_TDEST { O 1 vector } lef_ptr_TVALID { O 1 bit } lef_ptr_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lef_ptr_V_dest_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sef_ptr_TDEST { O 1 vector } sef_ptr_TVALID { O 1 bit } sef_ptr_TREADY { I 1 bit } } \
} "
} else {
