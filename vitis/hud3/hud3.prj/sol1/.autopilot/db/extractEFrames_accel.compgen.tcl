...
# FIFO definition: 
set ID 183
set FifoName extractEFrames_accel_fifo_w13_d2_S
...
# FIFO definition: 
set ID 184
set FifoName extractEFrames_accel_fifo_w12_d4_S
...
# FIFO definition: 
set ID 187
set FifoName extractEFrames_accel_fifo_w12_d2_S
...
# FIFO definition: 
set ID 188
set FifoName extractEFrames_accel_fifo_w12_d3_S
...
# FIFO definition: 
set ID 189
set FifoName extractEFrames_accel_fifo_w16_d3_S
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 194 \
			corename extractEFrames_accel_control_axilite \
			name extractEFrames_accel_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler extractEFrames_accel_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
