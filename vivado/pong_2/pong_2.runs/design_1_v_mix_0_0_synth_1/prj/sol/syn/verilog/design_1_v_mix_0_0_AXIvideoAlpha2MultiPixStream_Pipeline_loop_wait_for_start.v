...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((s_axis_video1_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((s_axis_video1_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        axi_last_V_fu_48 <= s_axis_video1_TLAST;
    end
end

always @ (*) begin
    if (((s_axis_video1_TVALID == 1'b0) | (ap_start_int == 1'b0))) begin
...
always @ (*) begin
    if ((~((s_axis_video1_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (sof_fu_87_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((s_axis_video1_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((s_axis_video1_TVALID == 1'b0) | (ap_start_int == 1'b0));
end
...
assign sof_fu_87_p1 = s_axis_video1_TUSER;

endmodule //design_1_v_mix_0_0_AXIvideoAlpha2MultiPixStream_Pipeline_loop_wait_for_start
