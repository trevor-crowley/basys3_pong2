...
set IPName      "v_mix"
set Version     "5.2"
set DisplayName "V_mix"
set Revision    "2112668769"
...
set xo_kernel_name "v_mix"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/trevor/Documents/xilinx/basys3_pong2/vivado/pong_2/pong_2.runs/design_1_v_mix_0_0_synth_1/prj/sol"
set debug_dir "/home/trevor/Documents/xilinx/basys3_pong2/vivado/pong_2/pong_2.runs/design_1_v_mix_0_0_synth_1/prj/sol/.debug"
set xo_hls_files_dir ""
set hdl_module_list {design_1_v_mix_0_0_flow_control_loop_pipe_sequential_init
design_1_v_mix_0_0_flow_control_loop_pipe_sequential_init
design_1_v_mix_0_0_flow_control_loop_pipe_sequential_init
design_1_v_mix_0_0_flow_control_loop_pipe_sequential_init
design_1_v_mix_0_0_flow_control_loop_pipe_sequential_init
design_1_v_mix_0_0_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "design_1_v_mix_0_0_v_mix"
set TopNoPrefix "v_mix"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 width W 0x0 "Data signal of width" {{0 16 width W 0 "Bit 15 to 0 of width"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 height W 0x0 "Data signal of height" {{0 16 height W 0 "Bit 15 to 0 of height"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 video_format W 0x0 "Data signal of video_format" {{0 16 video_format W 0 "Bit 15 to 0 of video_format"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 background_Y_R W 0x0 "Data signal of background_Y_R" {{0 16 background_Y_R W 0 "Bit 15 to 0 of background_Y_R"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 background_U_G W 0x0 "Data signal of background_U_G" {{0 16 background_U_G W 0 "Bit 15 to 0 of background_U_G"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 background_V_B W 0x0 "Data signal of background_V_B" {{0 16 background_V_B W 0 "Bit 15 to 0 of background_V_B"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 layerEnable W 0x0 "Data signal of layerEnable" {{0 32 layerEnable W 0 "Bit 31 to 0 of layerEnable"}}} {0x200 layerAlpha_1 W 0x0 "Data signal of layerAlpha_1" {{0 16 layerAlpha_1 W 0 "Bit 15 to 0 of layerAlpha_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x208 layerStartX_1 W 0x0 "Data signal of layerStartX_1" {{0 16 layerStartX_1 W 0 "Bit 15 to 0 of layerStartX_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x210 layerStartY_1 W 0x0 "Data signal of layerStartY_1" {{0 16 layerStartY_1 W 0 "Bit 15 to 0 of layerStartY_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x218 layerWidth_1 W 0x0 "Data signal of layerWidth_1" {{0 16 layerWidth_1 W 0 "Bit 15 to 0 of layerWidth_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x220 layerStride_1 W 0x0 "Data signal of layerStride_1" {{0 16 layerStride_1 W 0 "Bit 15 to 0 of layerStride_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x228 layerHeight_1 W 0x0 "Data signal of layerHeight_1" {{0 16 layerHeight_1 W 0 "Bit 15 to 0 of layerHeight_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x230 layerScaleFactor_1 W 0x0 "Data signal of layerScaleFactor_1" {{0 8 layerScaleFactor_1 W 0 "Bit 7 to 0 of layerScaleFactor_1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xff0 reserve W 0x0 "Data signal of reserve" {{0 16 reserve W 0 "Bit 15 to 0 of reserve"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axis_video s_axis_video1 m_axis_video"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
