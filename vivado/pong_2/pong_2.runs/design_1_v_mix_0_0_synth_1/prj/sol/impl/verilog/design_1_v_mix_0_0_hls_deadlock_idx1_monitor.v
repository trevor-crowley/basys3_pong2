...
module design_1_v_mix_0_0_hls_deadlock_idx1_monitor ( // for module design_1_v_mix_0_0_v_mix_inst.grp_VMixHlsDataFlowFunction_fu_398
    input wire clock,
    input wire reset,
...
wire idx6_block;
wire idx10_block;
wire [15:0] process_idle_vec;
wire [15:0] process_chan_block_vec;
wire [15:0] process_axis_block_vec;
wire df_has_axis_block;
wire all_process_stop;

assign block = monitor_find_block;
assign idx10_block = axis_block_sigs[-1];
assign process_axis_block_vec[0] = 1'b0;
assign process_idle_vec[0] = inst_idle_sigs[0];
assign process_chan_block_vec[0] = inst_block_sigs[0];
assign process_axis_block_vec[1] = idx2_block & (1'b0 | axis_block_sigs[-1] | axis_block_sigs[-1] | axis_block_sigs[-1]);
...
assign process_axis_block_vec[5] = idx6_block & (1'b0 | axis_block_sigs[-1] | axis_block_sigs[-1] | axis_block_sigs[-1]);
