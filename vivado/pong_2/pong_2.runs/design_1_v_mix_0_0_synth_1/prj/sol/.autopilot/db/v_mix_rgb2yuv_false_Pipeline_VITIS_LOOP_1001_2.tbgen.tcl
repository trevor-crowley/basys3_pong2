set moduleName v_mix_rgb2yuv_false_Pipeline_VITIS_LOOP_1001_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {v_mix_rgb2yuv<false>_Pipeline_VITIS_LOOP_1001_2}
...
set portList { 
	...
	{ outLayer1_dout sc_in sc_lv 24 signal 1 } 
	{ outLayer1_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ outLayer1_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ outLayer1_empty_n sc_in sc_logic 1 signal 1 } 
	{ outLayer1_read sc_out sc_logic 1 signal 1 } 
	{ outYuv_din sc_out sc_lv 24 signal 2 } 
	{ outYuv_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ outYuv_fifo_cap sc_in sc_lv 2 signal 2 } 
