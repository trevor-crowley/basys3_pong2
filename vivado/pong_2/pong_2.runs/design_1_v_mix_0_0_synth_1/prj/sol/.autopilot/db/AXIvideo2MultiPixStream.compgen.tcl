...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_read_c48 \
    op interface \
    ports { p_read_c48_din { O 1 vector } p_read_c48_num_data_valid { I 2 vector } p_read_c48_fifo_cap { I 2 vector } p_read_c48_full_n { I 1 bit } p_read_c48_write { O 1 bit } } \
} "
}
