set moduleName v_mix_422_to_444_false_2_Pipeline_VITIS_LOOP_60_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {v_mix_422_to_444<false>.2_Pipeline_VITIS_LOOP_60_2}
...
set portList { 
	...
	{ srcLayer1Yuv422_dout sc_in sc_lv 24 signal 1 } 
	{ srcLayer1Yuv422_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ srcLayer1Yuv422_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ srcLayer1Yuv422_empty_n sc_in sc_logic 1 signal 1 } 
	{ srcLayer1Yuv422_read sc_out sc_logic 1 signal 1 } 
	{ srcLayer1Yuv_din sc_out sc_lv 24 signal 2 } 
	{ srcLayer1Yuv_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ srcLayer1Yuv_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ srcLayer1Yuv_full_n sc_in sc_logic 1 signal 2 } 
	{ srcLayer1Yuv_write sc_out sc_logic 1 signal 2 } 
