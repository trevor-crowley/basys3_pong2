...
set C_modelArgList {
	...
	{ p_read_c47 int 1 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer0", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "p_read_c47", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ srcLayer0_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ srcLayer0_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ srcLayer0Yuv422_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ srcLayer0Yuv422_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ srcLayer0Yuv422_full_n sc_in sc_logic 1 signal 4 } 
	{ srcLayer0Yuv422_write sc_out sc_logic 1 signal 4 } 
	{ p_read_c47_din sc_out sc_lv 1 signal 5 } 
	{ p_read_c47_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ p_read_c47_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ p_read_c47_full_n sc_in sc_logic 1 signal 5 } 
	{ p_read_c47_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_read_c47_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "p_read_c47", "role": "din" }} , 
 	{ "name": "p_read_c47_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "p_read_c47", "role": "num_data_valid" }} , 
 	{ "name": "p_read_c47_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "p_read_c47", "role": "fifo_cap" }} , 
 	{ "name": "p_read_c47_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_read_c47", "role": "full_n" }} , 
 	{ "name": "p_read_c47_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_read_c47", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_420_to_422_false_Pipeline_VITIS_LOOP_31_2_fu_92", "Port" : "srcLayer0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "srcLayer0Yuv422", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_420_to_422_false_Pipeline_VITIS_LOOP_31_2_fu_92", "Port" : "srcLayer0Yuv422", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "p_read_c47", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "p_read_c47_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_29_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_420_to_422_false_Pipeline_VITIS_LOOP_31_2_fu_92", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_420_to_422_false_Pipeline_VITIS_LOOP_31_2_fu_92.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer0 { ap_fifo {  { srcLayer0_dout fifo_port_we 0 24 }  { srcLayer0_num_data_valid fifo_status_num_data_valid 0 2 }  { srcLayer0_fifo_cap fifo_update 0 2 }  { srcLayer0_empty_n fifo_status 0 1 }  { srcLayer0_read fifo_data 1 1 } } }
	...
	srcLayer0Yuv422 { ap_fifo {  { srcLayer0Yuv422_din fifo_port_we 1 24 }  { srcLayer0Yuv422_num_data_valid fifo_status_num_data_valid 0 2 }  { srcLayer0Yuv422_fifo_cap fifo_update 0 2 }  { srcLayer0Yuv422_full_n fifo_status 0 1 }  { srcLayer0Yuv422_write fifo_data 1 1 } } }
	p_read_c47 { ap_fifo {  { p_read_c47_din fifo_port_we 1 1 }  { p_read_c47_num_data_valid fifo_status_num_data_valid 0 2 }  { p_read_c47_fifo_cap fifo_update 0 2 }  { p_read_c47_full_n fifo_status 0 1 }  { p_read_c47_write fifo_data 1 1 } } }
}
