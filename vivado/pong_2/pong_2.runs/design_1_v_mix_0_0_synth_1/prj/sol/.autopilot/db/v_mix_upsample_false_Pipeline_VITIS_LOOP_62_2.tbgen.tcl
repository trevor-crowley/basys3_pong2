set moduleName v_mix_upsample_false_Pipeline_VITIS_LOOP_62_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {v_mix_upsample<false>_Pipeline_VITIS_LOOP_62_2}
...
set portList { 
	...
	{ srcLayer1Rgb_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ srcLayer1Rgb_fifo_cap sc_in sc_lv 2 signal 1 } 
	...
	{ srcLayer1x_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ srcLayer1x_fifo_cap sc_in sc_lv 2 signal 2 } 
