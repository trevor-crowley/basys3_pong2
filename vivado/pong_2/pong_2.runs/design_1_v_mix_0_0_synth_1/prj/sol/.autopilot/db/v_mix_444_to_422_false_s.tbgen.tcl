...
set C_modelArgList {
	...
	{ HwReg_width_c39 int 10 regular {fifo 1}  }
	{ HwReg_height_c43 int 10 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "outYuv", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "HwReg_width_c39", "interface" : "fifo", "bitwidth" : 10, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c43", "interface" : "fifo", "bitwidth" : 10, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ outYuv_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ outYuv_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ out422_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ out422_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ out422_full_n sc_in sc_logic 1 signal 3 } 
	{ out422_write sc_out sc_logic 1 signal 3 } 
	{ HwReg_width_c39_din sc_out sc_lv 10 signal 4 } 
	{ HwReg_width_c39_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ HwReg_width_c39_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ HwReg_width_c39_full_n sc_in sc_logic 1 signal 4 } 
	{ HwReg_width_c39_write sc_out sc_logic 1 signal 4 } 
	{ HwReg_height_c43_din sc_out sc_lv 10 signal 5 } 
	{ HwReg_height_c43_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ HwReg_height_c43_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ HwReg_height_c43_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_height_c43_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "HwReg_width_c39_din", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "HwReg_width_c39", "role": "din" }} , 
 	{ "name": "HwReg_width_c39_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "HwReg_width_c39", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_c39_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "HwReg_width_c39", "role": "fifo_cap" }} , 
 	{ "name": "HwReg_width_c39_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_width_c39", "role": "full_n" }} , 
 	{ "name": "HwReg_width_c39_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_width_c39", "role": "write" }} , 
 	{ "name": "HwReg_height_c43_din", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "HwReg_height_c43", "role": "din" }} , 
 	{ "name": "HwReg_height_c43_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "HwReg_height_c43", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_c43_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "HwReg_height_c43", "role": "fifo_cap" }} , 
 	{ "name": "HwReg_height_c43_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_height_c43", "role": "full_n" }} , 
 	{ "name": "HwReg_height_c43_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_height_c43", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "outYuv", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_444_to_422_false_Pipeline_VITIS_LOOP_673_2_fu_88", "Port" : "outYuv", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "out422", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_444_to_422_false_Pipeline_VITIS_LOOP_673_2_fu_88", "Port" : "out422", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "HwReg_width_c39", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "HwReg_width_c39_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "HwReg_height_c43", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "HwReg_height_c43_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_671_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_444_to_422_false_Pipeline_VITIS_LOOP_673_2_fu_88", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_444_to_422_false_Pipeline_VITIS_LOOP_673_2_fu_88.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	HwReg_width_c39 { ap_fifo {  { HwReg_width_c39_din fifo_port_we 1 10 }  { HwReg_width_c39_num_data_valid fifo_status_num_data_valid 0 2 }  { HwReg_width_c39_fifo_cap fifo_update 0 2 }  { HwReg_width_c39_full_n fifo_status 0 1 }  { HwReg_width_c39_write fifo_data 1 1 } } }
	HwReg_height_c43 { ap_fifo {  { HwReg_height_c43_din fifo_port_we 1 10 }  { HwReg_height_c43_num_data_valid fifo_status_num_data_valid 0 2 }  { HwReg_height_c43_fifo_cap fifo_update 0 2 }  { HwReg_height_c43_full_n fifo_status 0 1 }  { HwReg_height_c43_write fifo_data 1 1 } } }
}
