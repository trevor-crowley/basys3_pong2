...
#
# Generated by export_simulation on Sun Sep 04 18:31:22 EDT 2022
#
################################################################################
...
'-reset_run' switch to the './extractEFrames_accel_0.sh' script.

./extractEFrames_accel_0.sh -reset_run
...
./extractEFrames_accel_0.sh -noclean_files

For more information on the script, please type './extractEFrames_accel_0.sh -help'.
